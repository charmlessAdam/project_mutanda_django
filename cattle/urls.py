...
urlpatterns = [
    ...
    path('animals/create/', views.create_animal, name='create_animal'),
    path('animals/<int:animal_id>/', views.update_animal, name='update_animal'),
    ...
    path('weights/trend/', views.weight_trend, name='weight_trend'),

...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,18.197.254.230,agricore.nabutest.com,www.agricore.nabutest.com,api.agricore.nabutest.com').split(',')
